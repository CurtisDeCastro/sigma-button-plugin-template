...
client.config.configureEditorPanel([
  ...
  { name: "buttonBorderRadius",label: "Border Radius (px)", type: "text", defaultValue: "0", source: "ButtonFormat"},
  ...
  { name: "TextboxPadding", label: "Padding (px)", type: "text", defaultValue: "0", source: "TextboxFormat"},
    ...
    <div style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
      <Button 
        ...
        style={{
          ...
          width: 'calc(100% - ' + config.buttonPadding + 'px)',
          height: 'calc(100% - ' + config.buttonPadding + 'em)',
          objectFit: 'contain',
